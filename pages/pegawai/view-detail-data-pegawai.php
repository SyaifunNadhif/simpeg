            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header p-0 pt-1">
								<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
									...
									<li><a class="nav-link" href="#suamiistri" data-bs-toggle="tab">Suami Istri</a></li>
									<li><a class="nav-link" href="#anak" data-bs-toggle="tab">Anak</a></li>
									<li><a class="nav-link" href="#ortu" data-bs-toggle="tab">Ortu</a></li>
								</ul>
							</div>
							<!-- /.card-header -->
							<div class="card-body">	
								<div class="tab-content">
									...
									<div class="tab-pane table-responsive p-0" id="suamiistri">
									...
									<div class="tab-pane table-responsive p-0" id="anak">
										<table class="table table-hover text-nowrap table-bordered">
											<thead>
												<tr>
													<th>No</th>
									...
									<div class="tab-pane table-responsive p-0" id="ortu">
										<table class="table table-hover text-nowrap table-bordered">
											<thead>
												<tr>
													<th>NIK</th>
							...
							<div class="d-flex justify-content-end mt-3 pr-3">
								<a href="home-admin.php?page=form-view-data-pegawai" class="btn btn-outline-primary btn-sm shadow">
