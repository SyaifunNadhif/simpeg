<section class="content-header">
    <h1>Delete<small>Data Bahasa</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_bhs'])) {
	$id_bhs = $_GET['id_bhs'];
	$query   = "SELECT * FROM tb_bahasa WHERE id_bhs='$id_bhs'";
	...
	if (!empty($id_bhs) && $id_bhs != "") {
		$delete = "DELETE FROM tb_bahasa WHERE id_bhs='$id_bhs'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>	
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Bahasa ".$id_bhs." Berhasil di Hapus</p>
						<div class='row'>
