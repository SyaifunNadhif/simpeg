	...
	$id_bhs	=kdauto("tb_bahasa","");
			...
			<div class='box box-primary'>
				<div class='register-box-body'>
					...
					<div class='row'>
						...
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-master-data-bahasa' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>
			</div>";
		...
		if($query){
			echo "<div class='register-logo'><b>Input Data</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Input Data Bahasa Berhasil</p>
						<div class='row'>
							<div class='col-xs-8'></div>
							<div class='col-xs-4'>
								<button type='button' onclick=location.href='home-admin.php?page=form-master-data-bahasa' class='btn btn-danger btn-block'>Next >></button>
							</div>
						</div>
					</div>
				</div>";
