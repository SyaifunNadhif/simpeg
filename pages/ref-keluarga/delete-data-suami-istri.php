<section class="content-header">
    <h1>Delete<small>Data Suami Istri</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_si'])) {
	$id_si = $_GET['id_si'];
	$query   = "SELECT * FROM tb_suamiistri WHERE id_si='$id_si'";
	...
	if (!empty($id_si) && $id_si != "") {
		$delete = "DELETE FROM tb_suamiistri WHERE id_si='$id_si'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Suami / Istri ".$id_si." Berhasil di Hapus</p>
						<div class='row'>
