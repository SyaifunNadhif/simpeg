<section class="content-header">
    <h1>Delete<small>Data Anak</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_anak'])) {
	...
	$query   = "SELECT * FROM tb_anak WHERE id_anak='$id_anak'";
	...
	if (!empty($id_anak) && $id_anak != "") {
		$delete = "DELETE FROM tb_anak WHERE id_anak='$id_anak'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Anak ".$id_anak." Berhasil di Hapus</p>
						<div class='row'>
