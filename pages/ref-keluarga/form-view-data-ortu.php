 ...
 * MODULE   : View Data Orang Tua (Secure, Offline, Matching Ajax)
 *********************************************************/
...
// Ambil parameter UID (Jika view ini diakses dari detail pegawai)
    ...
    <div class="card card-modern">
        ...
        <div class="card-header-modern">
            <div>
                <div class="d-flex align-items-center">
                    <i class="fas fa-user-friends text-primary fa-lg mr-2"></i>
                    <h5 class="text-title">Data Orang Tua Pegawai</h5>
                </div>
                ...
                <?php else: ?>
                    <span class="text-subtitle pl-1">Menampilkan data orang tua dari semua pegawai.</span>
                <?php endif; ?>
            </div>
            ...
            <div class="header-actions">
                ...
                <?php if($is_admin): ?>
                <a href="home-admin.php?page=form-import-data-ortu" class="btn btn-outline-success btn-action-rounded shadow-sm">
                    <i class="fas fa-file-excel mr-1"></i> Import
                </a>
                <a href="home-admin.php?page=form-master-data-ortu&mode=add<?= $uid ? '&uid='.urlencode($uid) : '' ?>" class="btn btn-primary btn-action-rounded shadow-sm" style="background-color: #5D5FEF; border-color: #5D5FEF;">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table w-100" id="tabelOrtuAjax">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 shadow-lg rounded-lg">
            ...
            <div class="modal-body p-4">
                <p class="text-muted">Apakah Anda yakin ingin menghapus data orang tua ini?</p>
...
$(document).ready(function() {
    ...
    var table = $('#tabelOrtuAjax').DataTable({
        "processing": true,
        "serverSide": true,
        "ordering": false,
        "autoWidth": false,
        ...
        "columns": [
            ...
            { "data": "nama_ortu" },     // HTML (Nama Ortu + NIK)
    ...
    $('body').on('click', '.btn-delete', function(e) {
        ...
        $.ajax({
            url: 'pages/ref-keluarga/process_soft_delete_ortu.php', 
            type: 'POST',
            ...
            success: function(res) {
                if (res.status == 'success') {
                    $('#dataSummary').html(
                        '<strong>' + res.data.nama_ortu + ' (' + res.data.status_hub + ')</strong><br>' +
                        '<small class="text-muted">Orang Tua dari: ' + res.data.nama_peg + '</small>'
