<section class="content-header">
    <h1>Delete<small>Data Orang Tua</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_ortu'])) {
	...
	$query   = "SELECT * FROM tb_ortu WHERE id_ortu='$id_ortu'";
	...
	if (!empty($id_ortu) && $id_ortu != "") {
		$delete = "DELETE FROM tb_ortu WHERE id_ortu='$id_ortu'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Orang Tua ".$id_ortu." Berhasil di Hapus</p>
						<div class='row'>
