<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Referensi<small> Data Pengangkatan Pegawai</small></h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="home-admin.php">Home</a></li>
          <li class="breadcrumb-item active">Entry Data Pengangkatan Pegawai</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card-header">
						<h3 class="card-title">Form Entry Data Pengangkatan Pegawai</h3>
					</div>			
					<div class="card-body">
						<form role="form" id="formMutasi" action="home-admin.php?page=master-data-angkat" class="form-horizontal" method="POST" enctype="multipart/form-data">
							<div class="row">
	              <div class="col-sm-4">
									<div class="form-group">
										...
										$data = mysql_query("SELECT * FROM tb_pegawai WHERE status_kepeg <> 'Tetap'");        
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" style="text-transform:uppercase" name="status_kepeg" value="<?=$row['status_kepeg'];?>" class="form-control" maxlength="64" disabled>                   
                  </div>
                </div>
							</div>	
							<div class="row">
              ...
              <div class="row">
                <div class="col-sm-1">   
                  <div class="form-group">
                    ...
                    <input type="text" style="text-transform:uppercase" name="id_peg_baru" value="" class="form-control" required="required" maxlength="10">
                  </div>
                </div>
              </div>              
              <div class="row">
