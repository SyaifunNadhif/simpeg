			...
			<div class='box box-primary'>
				<div class='register-box-body'>
					...
					<div class='row'>
						...
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-master-data-cuti' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>
			</div>";
				...
				<div class='box box-primary'>
					<div class='register-box-body'>
						...
						<div class='row'>
							<div class='col-xs-8'></div>
							<div class='col-xs-4'>
								<button type='button' onclick=location.href='home-admin.php?page=form-master-data-cuti' class='btn btn-danger btn-block'>Next >></button>
							</div>
						</div>
					</div>
				</div>";
