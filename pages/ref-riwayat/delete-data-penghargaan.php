<section class="content-header">
    <h1>Delete<small>Data Penghargaan</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_penghargaan'])) {
	...
	$query   = "SELECT * FROM tb_penghargaan WHERE id_penghargaan='$id_penghargaan'";
	...
	if (!empty($id_penghargaan) && $id_penghargaan != "") {
		$delete = "DELETE FROM tb_penghargaan WHERE id_penghargaan='$id_penghargaan'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>	
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Penghargaan ".$id_penghargaan." Berhasil di Hapus</p>
						<div class='row'>
