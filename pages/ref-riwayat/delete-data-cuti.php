<section class="content-header">
    <h1>Delete<small>Data Cuti</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_cuti'])) {
	...
	$query   = "SELECT * FROM tb_cuti WHERE id_cuti='$id_cuti'";
	...
	if (!empty($id_cuti) && $id_cuti != "") {
		$delete = "DELETE FROM tb_cuti WHERE id_cuti='$id_cuti'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Cuti ".$id_cuti." Berhasil di Hapus</p>
						<div class='row'>
