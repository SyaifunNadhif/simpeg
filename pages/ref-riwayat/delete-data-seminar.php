<section class="content-header">
    <h1>Delete<small>Data Seminar</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_seminar'])) {
	...
	$query   = "SELECT * FROM tb_seminar WHERE id_seminar='$id_seminar'";
	...
	if (!empty($id_seminar) && $id_seminar != "") {
		$delete = "DELETE FROM tb_seminar WHERE id_seminar='$id_seminar'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>	
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Seminar ".$id_seminar." Berhasil di Hapus</p>
						<div class='row'>
