<section class="content-header">
    <h1>Master<small>Data Penugasan LN</small></h1>
    <ol class="breadcrumb">
        <li><a href="home-admin.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active">Data Penugasan LN</li>
    </ol>
</section>
			...
			<div class="row">
				<div class="col-md-12">	
					<div class="panel-body">
						<form action="home-admin.php?page=master-data-penugasan" class="form-horizontal" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" name="lama" class="form-control" maxlength="3">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Alasan Penugasan</label>
								<div class="col-sm-7">
									<input type="text" name="alasan" class="form-control" maxlength="128">
								</div>
							</div>
							<div class="form-group">
