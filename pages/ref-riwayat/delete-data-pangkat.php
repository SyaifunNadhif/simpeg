<section class="content-header">
    <h1>Delete<small>Data Pangkat</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_pangkat'])) {
	...
	$query   = "SELECT * FROM tb_pangkat WHERE id_pangkat='$id_pangkat'";
	...
	if (!empty($id_pangkat) && $id_pangkat != "") {
		$delete = "DELETE FROM tb_pangkat WHERE id_pangkat='$id_pangkat'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Pangkat ".$id_pangkat." Berhasil di Hapus</p>
						<div class='row'>
