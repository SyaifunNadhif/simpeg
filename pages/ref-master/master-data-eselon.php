<section class="content-header">
    <h1>Master<small>Data Eselon</small></h1>
    <ol class="breadcrumb">
...
<?php	
	...
	$cekname	=mysql_num_rows (mysql_query("SELECT nama_masteresl FROM tb_masteresl WHERE nama_masteresl='$_POST[nama_masteresl]'"));
		...
		echo "<div class='register-logo'><b>Oops!</b> Data Tidak Lengkap.</div>
			<div class='box box-primary'>
				<div class='register-box-body'>
					<p>Harap periksa kembali data pegawai. Pastikan Nama Eselon telah Anda masukan dengan lengkap dan benar</p>
					<div class='row'>
		...
		echo "<div class='register-logo'><b>Oops!</b> Duplikat Data</div>
			<div class='box box-primary'>
				<div class='register-box-body'>
					<p>Harap periksa kembali dan pastikan Nama Eselon yang Anda masukan benar.</p>
					<div class='row'>
						<div class='col-xs-8'></div>
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-admin.php?page=form-master-data-jabatan' class='btn btn-block btn-warning'>Back</button>
		...
		if($query){
			echo "<div class='register-logo'><b>Input Data</b> Successful!</div>	
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Input Data Master Eselon Berhasil</p>
						<div class='row'>
							<div class='col-xs-8'></div>
							<div class='col-xs-4'>
