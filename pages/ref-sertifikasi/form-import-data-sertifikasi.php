<?php
// form-upload-data-sertifikasi.php
$page_title = "Tambah";
$page_subtitle = "Kolektif Sertifikasi";
$breadcrumbs = [
  ["label" => "Dashboard", "url" => "home-admin.php"],
  ["label" => "Tambah Kolektif Sertifikasi"]
];
  ...
  <div class="container-fluid">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-upload"></i> Form Upload Data sertifikasi Kolektif</h3>
      </div>
      <div class="card-body">
        
        <div class="alert alert-light border">
          <i class="fas fa-file-excel text-success"></i> Unduh template upload:
          <a href="pages/ref-sertifikasi/template-upload-sertifikasi.xlsx" download class="btn btn-sm btn-success ml-2">
        ...
        <form id="uploadForm" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <a href="home-admin.php?page=form-view-data-sertifikasi" class="btn btn-secondary mr-2">
...
document.getElementById('uploadForm').addEventListener('submit', function(e) {
  ...
  // Kirim ke Backend
  fetch('pages/ref-sertifikasi/upload-data-sertifikasi.php', {
    method: 'POST',
    body: formData
  })
    ...
    .then(res => {
        if (res.status === 'success') {
            Swal.fire('Sukses!', res.message, 'success').then(() => {
                // Redirect ke halaman daftar sertifikasi setelah sukses
