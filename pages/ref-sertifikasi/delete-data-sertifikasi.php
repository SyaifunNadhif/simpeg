<section class="content-header">
    <h1>Delete<small>Data Diklat</small></h1>
    <ol class="breadcrumb">
...
if (isset($_GET['id_diklat'])) {
	...
	$query   = "SELECT * FROM tb_diklat WHERE id_diklat='$id_diklat'";
	...
	if (!empty($id_diklat) && $id_diklat != "") {
		$delete = "DELETE FROM tb_diklat WHERE id_diklat='$id_diklat'";
			...
			echo "<div class='register-logo'><b>Delete</b> Successful!</div>
				<div class='box box-primary'>
					<div class='register-box-body'>
						<p>Data Diklat ".$id_diklat." Berhasil di Hapus</p>
						<div class='row'>
