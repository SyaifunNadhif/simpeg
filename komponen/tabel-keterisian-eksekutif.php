...
<div class="card card-info">
  <div class="card-header">
    <h3 class="card-title">Keterisian Jabatan Eksekutif</h3>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table id="tabelEksekutif" class="table table-bordered table-sm table-striped">
        <thead>
          <tr>
            <th>Kode Jabatan</th>
